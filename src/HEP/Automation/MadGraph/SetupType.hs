...
data ScriptSetup = 
  SS { modeltmpldir :: String  -- ^ where model paramcard located, previously templatedir 
     ...
     , pythiapgsdir :: FilePath  -- ^ pythia6-pgs directory
     , pythia8dir    :: FilePath  -- ^ pythia8 directory 
...
deriving instance Typeable ProcessSetup  
...
deriving instance Typeable WorkSetup 
