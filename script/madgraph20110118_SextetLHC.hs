...
workdirname = "20110118_6LHC"

tasknamebase = "SixLHCFix200"

modelMass = [200,300,400,600]

coupling = 1.0

makeTaskname mass coup = tasknamebase ++ "Mass" ++ show mass 
...
createWorkDir workdir = do 
  ...
  let mybase = "/home/wavewave/ttbar/madgraph_auto/" 
      mytaskbase = mybase ++ "20110118_SextetLHC/"
...
generateEvents (workdir,taskname,mphi,coup) = do
  ...
  putStrLn "generating LHC events"
  let mybase = "/home/wavewave/ttbar/madgraph_auto/" 
